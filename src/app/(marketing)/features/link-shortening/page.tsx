            ...
            <MaxWidthWrapper>
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-xl mx-auto">
                        ...
                        Transform your content and monitor its impact with precision.
                        </h1>
                        <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
                        Streamline your workflow with efficient management and analytics. Track clicks and optimize your strategy effortlessly.
                        </p>
