...
export const PROCESS = [
    {
        ...
        description: "Efficiently categorize and manage your SaaS subscriptions for quick access and better control.",
        icon: FolderOpenIcon,
    },
    {
        title: "Customize and Integrate",
        description: "Tailor settings and integrate your SaaS tools to align with your business needs seamlessly.",
        icon: WandSparklesIcon,
    },
    {
        title: "Monitor and Optimize",
        description: "Gain insights into usage and performance to make data-driven improvements and maximize ROI.",
        icon: BarChart3Icon,
    },
] as const;
